...
(function(module, exports) {
    ...
    module.exports = {
        render: function() {
            ...
            return _c('Section', {
                staticClass: "head    cue-words-wrapper swiper-container",
                attrs: {
                    "data-from": "server"
                }
            }, [_c('Container', {
                staticClass: "cue-words swiper-wrapper"
            }, _vm._l((_vm.cueWords), function(item) {
                return _c('ListItem', {
                    staticClass: "hint-item  swiper-slide",
                    nativeOn: {
...
(function(module, exports) {
    ...
    exports.default = {
        methods: {
            feedInput: function feedInput(text) {
                this.feedUserInput({
                    "asr_type": "FINAL",
                    "content": text
                });
...
obj.props = ["bridge", "cueWords", "feedUserInput"];
obj.components = {
